...
export default function TarifarioRV({ Sliders }) {
  ...
  const beneficiosTarifario = (e) => {

    const boton1 = document.querySelector('#Tarifario-Editado_svg__boton');
    const boton2 = document.querySelector('#Tarifario-Editado_svg__boton2');
    const boton3 = document.querySelector('#Tarifario-Editado_svg__boton3');
  ...
  return (
    <div onLoad={beneficiosTarifario}>
      ...
      {beneficio3 ?
        ...
        : null}
      <div className="mt-6">
        <Tarifario className="w-[100%] h-[100%]"/>
      </div>
    </div>
  )
}
