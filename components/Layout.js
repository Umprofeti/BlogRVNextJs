        ...
        <>
            <div className='flex items-center justify-start w-[100%] xl:w-[40%]'>
                <Link href='/post/rendez-vous-magazine-latina'> 
                    <img  src={`https://apiblog.rendezvouscorp.com/wp-content/uploads/2021/09/image.svg`} className='w-full' alt='CARTA-EDITORIAL'/>
                </Link>
            </div>
                ...
                <div className='flex flex-col md:flex-row justify-center md:mt-9'>
                    ...
                    <div className='md:w-[33.3%]'>
                        <figure>
                            <Link href='/'>
                                <img
                                    src={`https://apiblog.rendezvouscorp.com/wp-content/uploads/2021/09/RV-LBlanco-300x240.png`} 
                                    alt='RV LOGO'
